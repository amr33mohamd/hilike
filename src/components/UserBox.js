        ...
        return (
          <ImageBackground source={{uri:'https://image.ibb.co/mRPfMK/10m.png'}} style={{flex: 1, height: 130,borderRadius: 10, marginHorizontal: 3, backgroundColor: 'white' }}>
            <View style={{flexDirection:'row'}}>
              <Text style={{color:'white',textAlign:'left',alignSelf:'flex-start',flex:.5,fontFamily:'Droid Sans',fontSize:20}}>1 KM</Text>
            ...
            <Text style={{color:'white',textAlign:'right',alignSelf:'flex-end',fontFamily:'Droid Sans',fontWeight:'bold',fontSize:12,padding:8,flex:.5,bottom:0,position:'absolute'}}>Amr Mohmed , 25 years old</Text>
          </ImageBackground>
